...
//                                     let pid = parts[1].parse::<i32>().unwrap();
//                                     match findbypid(pid) {
//                                         Ok(_) => app.output.push(format!("Found process {} with PID {}", process.name(), pid)),
//                                         Err(e) => app.output.push(format!("Error killing process: {}\n", e)),
//                                     }
//                                 }
//                             },
//                             "name" => {
//                                 if parts.len() == 2 {
//                                     let name = parts[1].parse::<str>().unwrap();
//                                     let matching_processes = findbyname(name);
//                                     if matching_processes.len() > 0 {
//                                         app.output.push(format!("Found {} processes with name '{}':", matching_processes.len(), name));
//                                         for process in matching_processes {
//                                             app.output.push(format!("PID: {}, Name: {}", process.pid(), process.name().unwrap_or("unknown process".to_string())));
//                                         }
//                                     } else {
//                                         app.output.push(format!("Error killing process: {}\n", e));
//                                     }
...
// pub fn findbypid(arg: i32) -> Option<sysinfo::Process> {
